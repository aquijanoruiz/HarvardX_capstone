...
```{r}
# We will load the data from Github and check the variables using the str function.
...
```{r, fig.align = "center", fig.height = 4, fig.width = 5, comment=FALSE, message= FALSE ,warning=FALSE}
...
```{r, fig.align = "center", fig.height = 4, fig.width = 7, comment=FALSE, message= FALSE ,warning=FALSE}
